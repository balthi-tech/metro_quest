...
// class GeoShapeDto {
//   final List<GeoPointDto> coordinates;
//   final String type;
...
//         return GeoPointDto(longitude: list[0] as double, latitude: list[1] as double);
//       }).toList(),
...
//       idrefligc: "IDFM:${csvRow['idrefligc'] ?? ''}",
